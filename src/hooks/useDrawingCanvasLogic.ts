...
export function useDrawingCanvasLogic({
    activeTool,
    strokeWidth,
    strokeColor,
    strokeStyle,
    ...
    }, [shapes, isDrawing, currentPoints, activeTool, strokeColor, strokeWidth, strokeStyle, width, height, drawShapeOnCanvas, canvasRef]);
