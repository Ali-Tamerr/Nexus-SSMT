...
import { useNodeEditorLogic } from '@/hooks/useNodeEditorLogic';

export function NodeEditor() {
  const { state, handlers } = useNodeEditorLogic();
  ...
  const {
    ...
    attachments, tags,
    showAttachmentMenu, setShowAttachmentMenu, showConnectionMenu, setShowConnectionMenu,
    attachmentMenuRef, connectionMenuRef, customColorPickerRef,
  ...
  return (
    <>
    <div className="fixed right-0 top-0 z-100 flex h-full w-full sm:w-96 flex-col border-l border-zinc-800 bg-zinc-900/95">
